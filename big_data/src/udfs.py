...
#     # Kiểm tra nếu giá trị là None, thay thế bằng chuỗi rỗng
#     mo_ta_cong_viec = mo_ta_cong_viec or ""
#     yeu_cau_ung_vien = yeu_cau_ung_vien or ""
#
#     # Tiến hành tìm kiếm framework như trước
#     return [framework for framework in patterns.framework_plattforms if
#             re.search(framework, mo_ta_cong_viec + " " + yeu_cau_ung_vien, re.IGNORECASE)]
#
#
# @udf(returnType=ArrayType(StringType()))
...
#         currency : a string
#         '''
#         if not currency:  # Kiểm tra nếu currency là None hoặc chuỗi rỗng
#             return None
#
