...
# framework_plattforms = ['Docker', 'OSP', 'Premiere', 'directAdmin', 'typography', 'Prometheus', 'visual weight',
#                         'Kubernetes', 'JDBC', 'UnitTest',
#                         'Servlets', 'cPanel', 'MySQL', '.NET', 'Ruby on Rails', 'JSP', 'IdentityServer', 'VoIP',
#                         'AdobeXD', 'CMake', 'Autocad',
#                         'Spring', 'Django', 'CRM', 'K8S', 'Nginx', 'firmware', 'Google Trend', 'psd', 'CSRF', 'Reactjs',
#                         'Struts', 'WebSocket',
#                         'Webpack', 'Spine', 'Vue', 'METEOR', 'Rancher', 'VFX', 'node js', 'Angular', 'Flask', 'ASP.NET',
#                         'Google Analystics', 'Zend',
#                         'Symfony', 'Express', 'Google Protobuf', 'J2EE', 'Ansible', 'WebForm', 'Videoscribe', 'CakePHP',
#                         'Hibernate', 'Git', 'Oracle',
#                         'Plesk', 'Log4j', 'JSON', 'Visio', 'Grafana', 'SDLC', ' EELinux', ' Redis', 'Redux', 'WinForm',
#                         'Figma', 'CodeIgniter',
#                         'Power BI', 'Bootstrap', 'WPF', 'Aerospike', 'bash shell', 'Laravel', 'SQL Server']
#
# design_patterns = ["design pattern", "MVC", " Singleton", " WPF", " MVVM", "Session Facade", " DAO ", "OOA/OOD",
#                    "Factory Pattern",
#                    'Microservice']
#
# knowledges = ['game', 'Jira', 'lắp đặt', 'interaction design', 'đồ họa', 'DevOps', ' AI ', ' async',
#               'Quality Assurance',
#               ' Security ', 'Google Drive', 'NFT', 'mạng máy tính', 'Wordpress', 'Machine Learning', 'Consult',
#               'White Box', 'sale',
#               'kiểm thử', 'đánh giá chất lượng', 'networking', 'distributed system', 'UI/UX', 'Windows', 'Unit Test',
#               'Jenkins', 'Chatbot', 'quản trị mạng', 'Solidity', 'tester', 'Corel Draw', 'Illustrator', 'Git',
#               'Android',
#               'Black Box', 'Office', 'chạy quảng cáo', 'Unix', 'IT Support', 'Data mining', 'data analys',
#               'cấu trúc dữ liệu', 'Switch',
#               ' TCP', 'qa', 'Animate', 'crypto', 'CI/CD', 'Defi', 'frontend', 'sửa chữa', 'SVN', 'phần cứng', ' sync',
#               'Powerpoint', 'smart contract', 'Linux', 'SCM', 'backend', 'Marketing', 'XSS', 'Photoshop', 'HTTP',
#               'Word', 'router', 'IOS',
#               'WebSocket', 'thuật toán', 'TestRail', 'CSDL', 'Sketch', 'blockchains', 'multithreading',
#               'hướng đối tượng', 'Front-end',
#
...
#                       'smart contract': 'blockchain_crypto', 'Solidity': 'blockchain_crypto',
...
#                       'cấu trúc dữ liệu': 'programming_basic', 'thuật toán': 'programming_basic',
#                       'OOP': 'programming_basic',
...
#              'XQuery',
#              'CoffeeScript', ' SR ', 'ECMAScript', 'Nial', ' Red ', 'Mesa', 'LSL', 'T-SQL', 'E#', ' GAP ', 'Simula',
#              'Logo', ' Caml',
